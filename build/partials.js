...
const FOOT_ARROW = '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M3 8h9M8 4l4 4-4 4" stroke="currentColor" stroke-width="1.4" fill="none"/></svg>';
const FOOT_FIDUCIAL = '<svg class="footer-plate__fid" viewBox="0 0 40 40" aria-hidden="true"><circle cx="20" cy="20" r="13" fill="none" stroke="#fff" stroke-width="1.4" opacity=".65"/><line x1="20" y1="1" x2="20" y2="12" stroke="#fff" stroke-width="1.4"/><line x1="20" y1="28" x2="20" y2="39" stroke="#fff" stroke-width="1.4"/><line x1="1" y1="20" x2="12" y2="20" stroke="#fff" stroke-width="1.4"/><line x1="28" y1="20" x2="39" y2="20" stroke="#fff" stroke-width="1.4"/><circle cx="20" cy="20" r="2.2" fill="#fff"/></svg>';
/* Routed copper traces + drilled vias — the block reads as a PCB, the thing Schmoll's machines drill */
const FOOT_PCB = '<svg class="footer-plate__pcb" viewBox="0 0 300 380" preserveAspectRatio="xMidYMid slice" fill="none" aria-hidden="true">'
  + '<g stroke="#fff" stroke-opacity=".15" stroke-width="2">'
  + '<path d="M0 58 H58 l16 16 H150"/><path d="M150 74 V132 l-14 14 V214"/>'
  + '<path d="M300 40 H240 l-16 16 V120 H150"/><path d="M44 322 H120 l18 -18 V232"/>'
  + '<path d="M300 298 H250 l-18 -18 V206"/></g>'
  + '<g stroke="#fff" stroke-opacity=".26" stroke-width="2" fill="#8a0f0f" fill-opacity=".55">'
  + '<circle cx="150" cy="74" r="6"/><circle cx="136" cy="214" r="6"/><circle cx="224" cy="120" r="6"/>'
  + '<circle cx="138" cy="232" r="6"/><circle cx="232" cy="206" r="6"/></g>'
  + '<g fill="#fff" fill-opacity=".16"><rect x="54" y="54" width="8" height="8"/><rect x="116" y="318" width="8" height="8"/></g>'
  + '</svg>';

const FOOTER = `<footer class="site-footer">
  <img class="footer-watermark" src="assets/monogram.svg" alt="" aria-hidden="true">
  <div class="container">
    <div class="footer-grid">
      ...
      <aside class="footer-plate">
        ${FOOT_PCB}
        ${FOOT_FIDUCIAL}
        <div class="footer-plate__body">
          <span class="footer-plate__reg">// <span data-i18n="foot.reg">Get in touch</span></span>
          <h3 data-i18n="foot.questions">You have questions?</h3>
          <div class="footer-plate__links">
            <a href="contact.html"><span data-i18n="nav.contact">Contact</span>${FOOT_ARROW}</a>
            <a href="careers.html"><span data-i18n="nav.careers">Careers</span>${FOOT_ARROW}</a>
          </div>
          <div class="footer-plate__mail">
    ...
    <div class="footer-bottom">
      ...
      <span class="footer-reg-string">EST. 1996 · GERMAN PRECISION ENGINEERING · ASIA PACIFIC</span>
    </div>
  </div>
</footer>`;
...
<link rel="stylesheet" href="assets/css/styles.css?v=87">
${head}</head>
<body>
